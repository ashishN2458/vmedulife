...
<html>
	...
	<body>
		<form class="form-horizontal" action="EditMobile.php" method="post" id="form" enctype="multipart/form-data">
			<fieldset>
				<!-- Form Name -->
				...
				<div class="form-group">
				  ...
				  <div class="col-md-4">
				 	 <input name="image" id="mobile_image" type="file" class="form-control" required="">
				  </div>
				</div>
		...
		$(document).ready(function(){
			$("#savebtn").click(function(evt){
		       ...
		       // Create an FormData object 
				...
				data.append('action','editmobile');
				 $.ajax({
				   type: "POST",
				   enctype: 'multipart/form-data',
				   url: "http://localhost/vmedulife/api.php",
				   data: data,
				   cache: false,
				   contentType: false, 
			       processData: false,
				   ...
				   {		
					   ...
					   if(status == 'success'){
						   window.location = 'http://localhost/vmedulife/AdminPage.php';
					   }					   
				   } 
				});
			});
